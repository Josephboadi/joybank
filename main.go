...
import (
	...
	_ "github.com/josephboadi/joybank/doc/statik"
	"github.com/josephboadi/joybank/gapi"
	"github.com/josephboadi/joybank/mail"
...
func runGrpcServer(config util.Config, store db.Store, taskDistributor worker.TaskDistributor) {
	...
	pb.RegisterJoyBankServer(grpcServer, server)
...
func runGatewayServer(config util.Config, store db.Store, taskDistributor worker.TaskDistributor) {
	...
	err = pb.RegisterJoyBankHandlerServer(ctx, grpcMux, server)
	if err != nil {
