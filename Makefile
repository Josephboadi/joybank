...
mock:
	 ...
	 mockgen -package mockwk -destination worker/mock/distributor.go github.com/josephboadi/joybank/worker TaskDistributor
...
proto:
    ...
    --openapiv2_out=doc/swagger --openapiv2_opt=allow_merge=true,merge_file_name=joy_bank \
	proto/*.proto
...
.PHONY: createdb dropdb migrateup migratedown migrateup1 migratedown1 new_migration db_docs db_schema sqlc test server mock proto evans redis
